...
addpath(genpath('C:\Documents and Settings\bauernfeind\Desktop\BCI\Offline'));

here = pwd;
cd 'C:\Documents and Settings\bauernfeind\Desktop\BCI\binaries'
setpath
cd(here)
...
strArray(1) = java.lang.String('Z:/oBCI/NIRx/EEG/EEG_Laser_Daten/infile/EEG_N10_RL.gdf');
strArray(2) = java.lang.String('Z:/oBCI/NIRx/EEG/EEG_Laser_Daten/infile/EEG_N09_RL.gdf');
% strArray(3) = java.lang.String('EEG/EEG_Laser_Daten/infile/EEG_N08_RL.gdf');
% % strArray(4) = java.lang.String('EEG/EEG_Laser_Daten/EEG_N06_PVL.gdf');
data = cell(strArray);
