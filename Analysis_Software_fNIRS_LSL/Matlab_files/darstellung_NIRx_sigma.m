function darstellung_NIRx_sigma(c,oxy_signal,deoxy_signal,std_oxy_signal,std_deoxy_signal, NIRx,t_trial,fs, Gruppe, DataPath, AnalysePath, Task,ImageClass)
...
if DisplaySteps
    if (c==kanal || kanal == -1) && NIRx.settings.createFigures
        ...
        title(['Avg. Concentration Change of Channel' num2str(c)],'FontSize',12,'FontWeight','demi','Interpreter','none')
        %
        ylabel('(mM mm)','FontSize',12)
        legend('[deoxy-Hb]','[oxy-Hb]')
        
        if NIRx.settings.corrmode==0
            print( '-dpng', '-r300', [DataPath, Gruppe, '\', AnalysePath, '\',NIRx.settings.Subj,'_',Task,'_',ImageClass,'_gem-Konzentrationsänderung', '_','Kanal',num2str(c),NIRx.settings.Usage.CAR,NIRx.settings.Usage.corrmode]);
            saveas(gcf, [DataPath, Gruppe, '\', AnalysePath, '\',NIRx.settings.Subj,'_',Task,'_',ImageClass,'_gem-Konzentrationsänderung', '_','Kanal',num2str(c),NIRx.settings.Usage.CAR,NIRx.settings.Usage.corrmode],'fig');
        else
            print( '-dpng', '-r300', [DataPath, Gruppe, '\', AnalysePath, '\',NIRx.settings.Subj,'_',Task,'_',ImageClass,'_gem-Konzentrationsänderung', '_','Kanal',num2str(c),NIRx.settings.Usage.CAR,NIRx.settings.Usage.TFICA,NIRx.settings.Usage.corrmode]);
            saveas(gcf, [DataPath, Gruppe, '\', AnalysePath, '\',NIRx.settings.Subj,'_',Task,'_',ImageClass,'_gem-Konzentrationsänderung', '_','Kanal',num2str(c),NIRx.settings.Usage.CAR,NIRx.settings.Usage.TFICA,NIRx.settings.Usage.corrmode],'fig');
        end
    end
end
end
