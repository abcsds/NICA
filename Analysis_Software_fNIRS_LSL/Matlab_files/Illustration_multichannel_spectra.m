...
function [rOxy rDeoxy]=Illustration_multichannel_spectra(ChNr, oxy_Data, deoxy_Data, fs, dispFreq, ExCh, NIRx, D)
    ...
    elseif NIRx.settings.probeset==52
    ...
    elseif NIRx.settings.probeset==99
        if ChNr==1
            subplot(5,11,53);
        elseif ChNr==2
            subplot(5,11,51);
    ...
    elseif NIRx.settings.probeset==777
    ...
    elseif NIRx.settings.probeset==888
        if ChNr==1
            subplot(14,13,7);
        elseif ChNr==2
            subplot(14,13,19);
