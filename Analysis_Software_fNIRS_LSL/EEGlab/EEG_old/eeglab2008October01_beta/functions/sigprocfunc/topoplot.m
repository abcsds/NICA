...
if isempty(plotrad) 
  ...
  plotrad = max(plotrad,rmax);                 % default: plot out to the 0.5 head boundary
...
%   [Xi,Yi,Zi] = griddata(inty,intx,intValues,yi',xi,'invdist'); % interpolate data %original
[Xi,Yi,Zi] = griddata_old(inty,intx,intValues,yi',xi,'invdist'); % interpolate data %günher nach wechsel auf 2012 matlab
  %
