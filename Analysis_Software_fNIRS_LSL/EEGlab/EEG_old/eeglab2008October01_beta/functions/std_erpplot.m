...
% $Log: std_erpplot.m,v $
% Revision 1.1  2007/10/19 20:52:07  nima
% zero indicator line added for erp plot in cluster properties.
%
...
if ~isempty(opt.channels)
    ...
    if strcmpi(opt.plotmode, 'condensed') && strcmpi(opt.mode, 'together')    
    ln = line([0 0],get(gca,'ylim'));
