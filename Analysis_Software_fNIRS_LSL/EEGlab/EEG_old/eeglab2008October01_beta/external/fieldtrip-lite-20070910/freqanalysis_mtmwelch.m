...
% where the data should be organised in a structure as obtained from
...
% average over time
% NOTE: the degrees of freedom should be returned by freqnalalysis_mtmconvol, 
