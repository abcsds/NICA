...
%
% Use as
%   [waveletData] = freqanalysis_tfr(cfg,data)
% where data is the output of PREPROCESSING, and the configuration structure
% should contain
%
...
cfg.version.id = '$Id: freqanalysis_tfr.m,v 1.19 2007/03/27 11:00:28 ingnie Exp $';
