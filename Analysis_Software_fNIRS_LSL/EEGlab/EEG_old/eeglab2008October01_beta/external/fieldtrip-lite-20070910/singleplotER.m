...
for k=1:length(varargin)
  ...
  if ~strcmp(cfg.baseline, 'no')
    ...
    elseif strcmp(cfg.yparam, 'freq')
      ...
      warning('Baseline not applied, please set cfg.yparam');
    end
  end
end
...
cfg.channel = channelselection(cfg.channel, varargin{1}.label);
if isempty(cfg.channel)
  error('no channels selected');
else
  chansel = match_str(varargin{1}.label, cfg.channel);
end
